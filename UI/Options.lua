                ...
                guildFound = {
                    ...
                    args = {
                        ...
                        integrity = {
                            ...
                            desc = "While any Guild Found restriction above is on, detect gold or items that moved across a window a member had the addon disabled — the closed-economy blind spot when someone turns the addon off, trades or mails value with an outsider, then turns it back on. The next login the addon was loaded, it compares wealth against the last snapshot it saw and reports ANY difference, flagging the member for officer review — in a closed economy no play without the addon is acceptable, so there is no tolerance. Best-effort/heuristic (officers judge legitimate sources like mob loot or quest gold); a modified addon can still forge it.",
                            width = "full",
                            disabled = notGuildLeader,
